...
{    
    XMLDataParser* XMLDataParser::create(){
        XMLDataParser* dataParser = new XMLDataParser();
        return dataParser;
    }
    
    TextureAtlasData* XMLDataParser::parseTextureAtlasData(const dragonBones::XMLElement *rootElement, float scale)
    {
    ...
    */
    SkeletonData *XMLDataParser::parseSkeletonData(const XMLElement *rootElement)
    {
