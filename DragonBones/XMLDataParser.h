...
namespace dragonBones
{
    ...
    public:
        ...
        static XMLDataParser* create();
        
        TextureAtlasData* parseTextureAtlasData(const dragonBones::XMLElement *rootElement, float scale = 1.0);
        
        /**
         * Parse the SkeletonData.
         * @param    xml The SkeletonData xml to parse.
         * @return A SkeletonData instance.XMLDataParser(){};
         */
        SkeletonData *parseSkeletonData(const XMLElement *rootElement);
    private:
