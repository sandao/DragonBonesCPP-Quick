...
{
    Cocos2dxTextureAtlas* Cocos2dxTextureAtlas::create(TextureAtlasData *data){
        Cocos2dxTextureAtlas* tex = new Cocos2dxTextureAtlas(data);
        return tex;
    }
    Cocos2dxTextureAtlas::Cocos2dxTextureAtlas(TextureAtlasData *data)
        : _textureAtlasRawData(data)
    {
        textureAtlas = cocos2d::CCTextureAtlas::create(data->imagePath.c_str() , (int)(data->rects.size()));
